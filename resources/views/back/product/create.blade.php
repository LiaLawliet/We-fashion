                ...
                <form action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    @forelse($genres as $id => $name)
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="genre_id" id="genres{{$id}}" {{ old('genre_id')==$id? 'checked' : '' }} value="{{$id}}">
                            <label class="form-check-label" for="genre{{$id}}">{{$name}}</label>
                        </div>
                    @empty
                    @endforelse
                    @if($errors->has('genre_id')) <span class="alert-danger">{{$errors->first('genre_id')}}</span>@endif
